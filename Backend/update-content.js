    ...
    content: JSON.stringify([
      {
        ...
        data: {
          ...
          description:
            "Portal informasi Green Campus PPNS — komitmen kami menuju kampus yang hijau, bersih, berkelanjutan, dan ramah lingkungan.",
      ...
      },
      {
        ...
        data: {
          ...
          items: [
            {
              value: "95%",
              label: "Pengurangan Emisi",
              description: "Sejak 2020",
            },
            {
              value: "12",
              label: "Program Hijau",
            ...
            },
            {
              value: "5.000+",
              label: "Pohon Ditanam",
              description: "Di area kampus",
            },
            {
              value: "80%",
              label: "Daur Ulang",
              description: "Sampah terkelola",
            },
          ],
        },
      },
      {
        ...
        data: {
          ...
          highlight: "Hijau",
          description:
            "Berbagai program lingkungan yang kami selenggarakan untuk menciptakan kampus berkelanjutan.",
          items: [
            {
              icon: "🌱",
              title: "Penghijauan Kampus",
              description:
                "Program penanaman pohon dan perawatan taman di seluruh area kampus.",
            },
            {
              icon: "♻️",
              title: "Bank Sampah",
              description:
                "Pengelolaan sampah terpadu dengan sistem 3R (Reduce, Reuse, Recycle).",
            },
            {
              icon: "💡",
              title: "Hemat Energi",
              description:
                "Penggunaan panel surya dan lampu LED hemat energi di seluruh gedung.",
            },
            {
              icon: "🚲",
              title: "Kampus Bersepeda",
              description:
                "Fasilitas parkir sepeda dan jalur khusus untuk mendukung transportasi hijau.",
            },
            {
              icon: "💧",
              title: "Konservasi Air",
              description:
                "Sistem penampungan air hujan dan pengolahan air limbah terpadu.",
            },
            {
              icon: "📚",
              title: "Edukasi Hijau",
              description:
                "Seminar dan workshop tentang lingkungan untuk sivitas akademika.",
            },
          ],
        },
      },
        ...
        data: {
          ...
          images: [
            ...
            },
            {
              ...
              title: "Daur Ulang",
              description: "Kreativitas dari limbah",
            },
            {
              image:
                "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80",
              title: "Bersepeda",
              description: "Transportasi hijau",
            },
            {
              image:
                "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600&q=80",
              title: "Edukasi",
              description: "Seminar lingkungan",
            },
          ],
        },
      },
      {
        ...
        data: {
          ...
          subtitle:
            "Dapatkan informasi terbaru seputar program dan kegiatan Green Campus PPNS.",
          buttons: [
    ...
    content: JSON.stringify([
      {
        ...
        data: {
          ...
          description:
            "Green Campus PPNS adalah inisiatif untuk menciptakan lingkungan kampus yang ramah lingkungan, berkelanjutan, dan mendukung pembangunan hijau.",
      ...
      },
      {
        ...
        data: {
          ...
          items: [
            ...
            {
              value: "80%",
              label: "Daur Ulang Sampah",
              description: "Terkelola dengan baik",
            },
            {
              value: "12",
              label: "Program Aktif",
              description: "Berjalan setiap tahun",
            },
          ],
        },
      },
      {
        ...
        data: {
          ...
          subtitle:
            "Hubungi kami untuk informasi lebih detail tentang program Green Campus PPNS.",
          buttons: [
    ...
    content: JSON.stringify([
      {
        ...
        data: {
          ...
          description:
            "Berbagai program dan inisiatif hijau yang kami jalankan untuk mewujudkan kampus berwawasan lingkungan.",
          ...
          image:
            "https://images.unsplash.com/photo-1581092335391-9583eb1c0f6a?w=1920&q=80",
        },
      },
      {
        type: "text",
          ...
          items: [
            {
              ...
              title: "Penghijauan",
              description:
                "Penanaman pohon, taman vertikal, dan ruang terbuka hijau di seluruh area kampus.",
            },
            {
              icon: "☀️",
              title: "Energi Terbarukan",
              description:
                "Panel surya, lampu LED hemat energi, dan sistem manajemen energi pintar.",
            },
            {
              icon: "♻️",
              title: "Pengelolaan Sampah",
              description:
                "Bank sampah, komposting, dan program 3R yang melibatkan mahasiswa.",
            },
            {
              icon: "💧",
              title: "Konservasi Air",
              description:
                "Penampungan air hujan, pengolahan air limbah, dan kampanye hemat air.",
            },
            {
              icon: "🚲",
              title: "Transportasi Hijau",
              description:
                "Jalur sepeda, shuttle listrik, dan area parkir ramah lingkungan.",
            },
            {
              icon: "📖",
              title: "Edukasi Lingkungan",
              description:
                "Kurikulum hijau, workshop, dan seminar kesadaran lingkungan.",
            },
          ],
        },
      },
      {
        ...
        data: {
          ...
          subtitle:
            "Dukung program Green Campus PPNS dan jadi bagian dari perubahan.",
          buttons: [
            { label: "Hubungi Kami", link: "/kontak", variant: "primary" },
          ...
          images: [
            {
              image:
                "https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?w=600&q=80",
              title: "Penghijauan",
              description: "Penanaman pohon di area kampus",
            },
            {
              image:
                "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=600&q=80",
              title: "Pengelolaan Sampah",
              description: "Pemilahan sampah terpadu",
            },
            {
              image:
                "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=600&q=80",
              title: "Panel Surya",
              description: "Energi bersih untuk kampus",
            },
            {
              image:
                "https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?w=600&q=80",
              title: "Kreativitas Daur Ulang",
              description: "Kerajinan dari limbah",
            },
            {
              image:
                "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&q=80",
              title: "Bersepeda",
              description: "Go Green transportasi",
            },
            {
              image:
                "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=600&q=80",
              title: "Seminar Hijau",
              description: "Edukasi lingkungan",
            },
          ],
        },
      },
    ...
    content: JSON.stringify([
      {
        ...
        data: {
          ...
          subtitle: "Green Campus",
          description:
            "Informasi terbaru seputar program Green Campus dan kegiatan lingkungan di PPNS.",
          image:
            "https://images.unsplash.com/photo-1504711434969-e33886168d8c?w=1920&q=80",
        },
      },
      {
        type: "text",
    ...
    content: JSON.stringify([
      {
        ...
        data: {
          ...
          description:
            "Silakan hubungi kami untuk informasi lebih lanjut tentang program Green Campus PPNS.",
          image:
            "https://images.unsplash.com/photo-1557426272-fc759fdf7a8d?w=1920&q=80",
        },
      },
      {
        type: "features",
          ...
          items: [
            {
              ...
              title: "Alamat",
              description:
                "Jl. Teknik Kimia, Keputih, Sukolilo, Surabaya 60111",
            },
            { icon: "📞", title: "Telepon", description: "(031) 594 7464" },
            {
              icon: "📧",
              title: "Email",
              description: "green.campus@ppns.ac.id",
            },
            {
              icon: "🕐",
              title: "Jam Kerja",
    ...
    content: JSON.stringify([
      {
        ...
        data: {
          ...
          description:
            "Dokumen dan laporan terkait program Green Campus PPNS yang dapat diunduh.",
          image:
...
async function update() {
  ...
  for (const p of pages) {
    await conn.query("UPDATE pages SET title = ?, content = ? WHERE slug = ?", [
      p.title,
      p.content,
      p.slug,
    ]);
