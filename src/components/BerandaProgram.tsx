...
import type { Program, BentoItem, Facility, KerjasamaItem } from "@/types";

interface BerandaProgramProps {
  programs?: Program[];
  bentoItems?: BentoItem[];
  facilities?: Facility[];
  kerjasama?: KerjasamaItem[];
}
...
export default function BerandaProgram({
  ...
  const BENTO_ITEMS = bentoItems ?? [];
  const FASILITAS = facilities ?? [];
