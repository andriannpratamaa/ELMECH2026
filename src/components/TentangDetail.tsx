...
const ABOUT_DATA = getAboutData();

export default function TentangDetail() {
  return (
    <section className="relative pt-0 pb-16 sm:pb-20 bg-white overflow-hidden">
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
      <div className="absolute w-[500px] h-[500px] rounded-full blur-[120px] opacity-[0.03] pointer-events-none" style={{ background: '#1E3A8A', top: '5%', left: -100 }} />
      <div className="absolute w-[400px] h-[400px] rounded-full blur-[100px] opacity-[0.02] pointer-events-none" style={{ background: '#FBBF24', bottom: '20%', right: -80 }} />
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative h-[400px] sm:h-[500px] rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-semibold text-lg font-[family-name:var(--font-display)]">Politeknik Perkapalan Negeri Surabaya</span>
                </div>
            ...
            <div className="absolute -bottom-4 -right-4 w-24 h-24 rounded-2xl bg-[#FBBF24]/10 border border-[#FBBF24]/20 flex items-center justify-center backdrop-blur-md">
              <span className="text-2xl font-black text-[#FBBF24] font-[family-name:var(--font-display)]">28+</span>
            </div>
          </motion.div>
        </div>
            ...
            <div className="relative h-[350px] sm:h-[420px] rounded-3xl overflow-hidden shadow-xl">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-white font-semibold text-lg font-[family-name:var(--font-display)]">Visi & Misi</span>
                </div>
                <p className="text-white/60 text-sm mt-1">Arah dan tujuan institusi</p>
              </div>
            </div>
              ...
              {ABOUT_DATA.misi.map((m, i) => (
                <li key={i} className="flex items-start gap-3 group">
                  <span className="w-7 h-7 rounded-full bg-[#FBBF24]/20 flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:bg-[#FBBF24]/30 transition-colors">
                    <span className="text-xs font-bold text-[#FBBF24]">{i + 1}</span>
                  </span>
                  <span className="text-sm sm:text-base text-gray-600 leading-relaxed">{m}</span>
                </li>
              ))}
            </ul>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {ABOUT_DATA.pimpinan.map((p, i) => (
              ...
              >
                ...
                <h3 className="text-sm font-semibold text-[#0F172A] mb-1">{p.nama}</h3>
          ...
          <div className="rounded-3xl bg-gradient-to-br from-[#0F172A] to-[#1E3A8A] p-10 sm:p-14 relative overflow-hidden">
            ...
            <div className="relative z-10 grid sm:grid-cols-3 gap-8 text-center sm:text-left">
              {[
                ...
                return (
                  <div key={item.label} className="sm:border-r sm:border-white/10 sm:last:border-r-0 sm:px-8 first:sm:pl-0 last:sm:pr-0">
                    <Icon className="w-8 h-8 text-[#FBBF24] mb-4 sm:mx-0 mx-auto" strokeWidth={1.5} />
