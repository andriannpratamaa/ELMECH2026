...
import { ArrowRight, ChevronDown, GraduationCap, Award, MapPin, TrendingUp, BookOpen, Building2, Users, Star } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative lg:min-h-[85vh] flex items-center overflow-hidden bg-[#0F172A] pt-[120px] pb-20 lg:pt-0 lg:pb-0">
      <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              className="text-sm sm:text-base md:text-base lg:text-lg text-blue-100/70 leading-relaxed max-w-[500px] mx-auto lg:mx-0 mb-2 lg:mb-0"
            >
            ...
            <motion.div
              ...
              <div className="space-y-1.5">
                <h3 className="text-base lg:text-lg font-bold text-[#0F172A] leading-snug font-[family-name:var(--font-display)]">
                  PPNS Raih Akreditasi Unggul 2025
                </h3>
                <p className="text-xs sm:text-sm text-gray-500 leading-relaxed">
                  Peringkat akreditasi institusi meningkat ke status Unggul dari BAN-PT.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 pt-4 border-t border-gray-100">
                {[
                  ...
                  { icon: Award, value: 'Unggul', label: 'Akreditasi' },
                  { icon: Users, value: '10rb+', label: 'Mahasiswa Aktif' },
                  { icon: MapPin, value: 'Surabaya', label: 'Kampus Utama' },
                ].map((item) => {
                  const Icon = item.icon;
                  return (
                    <div key={item.label} className="text-center p-1.5">
                      <Icon className="w-4 h-4 text-[#FBBF24] mx-auto mb-1" strokeWidth={1.5} />
                      <div className="text-base sm:text-lg font-black text-[#0F172A]">{item.value}</div>
                      <div className="text-[10px] sm:text-[11px] text-gray-500 font-medium">{item.label}</div>
                    </div>
                  );
                })}
              </div>
              ...
              <div className="flex items-center gap-2.5 p-3 rounded-2xl bg-gradient-to-r from-[#0F172A]/5 to-transparent border border-gray-100/80">
                ...
                <span className="text-[11px] sm:text-xs text-gray-500">Penerimaan Mahasiswa Baru 2026/2027 dibuka</span>
              </div>
            </motion.div>
