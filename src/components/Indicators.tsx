...
export default function Indicators() {
  return (
    <section id="program" className="relative py-28 sm:py-36 lg:py-44 bg-[#F8FAFC] overflow-hidden">
              ...
              >
                ...
                <div className="relative z-10 h-full flex flex-col justify-between p-6 sm:p-8">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1.5 text-[#FBBF24] text-sm font-medium mt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
