    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center gap-3">
                <Link href="/teknisi/labs" className="p-2 rounded-xl hover:bg-white/5 text-white/50 hover:text-white transition-colors">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-white flex items-center gap-1.5">
                                    ...
                                    {lab.teknisi_name || (lab.teknisi_id ? `User #${lab.teknisi_id}` : "—")}
                                </p>
                            </div>
                            <div>
