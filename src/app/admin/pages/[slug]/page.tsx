...
import { ArrowLeft, Save, Loader2, Plus, Trash2, GripVertical, Eye, EyeOff } from "lucide-react";
...
function BlockEditor({
  ...
  const renderField = (field: string) => {
    ...
    if (field === "body") {
      return (
        <div key={field}>
          <label className="block text-xs font-medium text-white/50 mb-2 capitalize">Isi Konten</label>
          <TiptapEditor
            value={value}
    ...
    if (field === "items" || field === "buttons") {
      ...
      return (
        <div key={field}>
          ...
          >
            + Tambah {field === "items" ? "item" : field === "buttons" ? "tombol" : "item"}
          </button>
        </div>
      );
    }
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white font-[family-name:var(--font-display)]">Pratinjau Halaman</h1>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-white font-[family-name:var(--font-display)]">Edit Halaman</h1>
            <p className="text-sm text-white/40 mt-1">/{slug}</p>
          </div>
        </div>
