...
export default function PagesListPage() {
  ...
  const handleAddNavbarItem = async () => {
    ...
    try {
      ...
      // Build payload - NEW: Uses page_id instead of href
      const payload = {
        label: newLabel,
        page_id: newPageId,
  ...
  return (
    <div className="space-y-4">
      ...
      {tab === "navbar" && (
        <div className="space-y-4">
          {/* Add new item form - NEW ARCHITECTURE: CMS Page selector instead of manual href */}
