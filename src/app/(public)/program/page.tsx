...
import { GraduationCap, BookOpen, Building2, Users, Ship, Zap, Cog, Wrench, Microscope, Cpu, CheckCircle } from 'lucide-react';
import PageHero from '@/components/PageHero';
import SectionTitle from '@/components/SectionTitle';
import ProgramCard from '@/components/ProgramCard';
import CTASection from '@/components/CTASection';
import { getPrograms, getBentoItems, getFacilities, getKerjasama } from '@/services/api';
import { Factory, FlaskConical, Monitor, Globe } from 'lucide-react';

const PROGRAMS = getPrograms();
const BENTO_ITEMS = getBentoItems();
const FASILITAS = getFacilities();
const KERJASAMA = getKerjasama();
...
export default function ProgramPage() {
  return (
    <>
      <PageHero
        bgImage="https://images.unsplash.com/photo-1581092335391-9583eb1c0f6a?w=1440&q=80"
        title="Program Unggulan"
        subtitle="Program pendidikan dan inovasi maritim modern"
      ...
      <section className="relative pt-8 sm:pt-12 pb-16 sm:pb-20 bg-[#F8FAFC] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle badge="Inovasi Unggulan" title="Program" highlight="Unggulan" />
      ...
      <section className="relative py-20 sm:py-28 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            ...
            title="Semua"
            highlight="Program"
            description="PPNS menawarkan enam program studi unggulan di bidang teknologi maritim yang dirancang untuk memenuhi kebutuhan industri global."
          />
      ...
      <section className="relative py-20 sm:py-28 bg-[#F8FAFC] overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle badge="Fasilitas" title="Fasilitas" highlight="Modern" />
      ...
      <section className="relative py-20 sm:py-28 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="rounded-3xl bg-gradient-to-br from-[#0F172A] to-[#1E3A8A] p-10 sm:p-14 relative overflow-hidden"
          >
            ...
            <div className="relative z-10 grid sm:grid-cols-3 gap-8 text-center">
              {[
                { icon: GraduationCap, value: '25+', label: 'Program Studi' },
                { icon: BookOpen, value: '100%', label: 'Terakreditasi' },
                ...
                return (
                  <div key={item.label} className="sm:border-r sm:border-white/10 sm:last:border-r-0 sm:px-8">
                    <Icon className="w-8 h-8 text-[#FBBF24] mx-auto mb-4" strokeWidth={1.5} />
      ...
      <section className="relative py-20 sm:py-28 bg-[#F8FAFC] overflow-hidden">
        ...
        <div className="absolute w-[500px] h-[500px] rounded-full blur-[120px] opacity-[0.03] pointer-events-none" style={{ background: '#1E3A8A', top: '10%', left: -100 }} />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle badge="Kerjasama" title="Mitra" highlight="Industri" />
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {KERJASAMA.map((item, i) => (
              <motion.div
                key={item.name}
                ...
                className="relative p-5 rounded-2xl bg-white border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#FBBF24]/20 transition-all duration-500 group overflow-hidden"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl from-[#1E3A8A]/5 to-transparent rounded-bl-full" />
