    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 auto-rows-[200px] lg:auto-rows-[240px]">
            {BENTO_ITEMS.map((item, i) => {
              ...
              const sizeClass =
                sizeClasses[item.size] || "lg:col-span-1 lg:row-span-1";
              const mobileClass =
                mobileSizeClasses[item.size] || "sm:col-span-1 row-span-1";
              return (
                <div
                  key={item.title}
                ...
                >
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-85`}
                  />
      ...
      <section className="relative py-20 sm:py-28 bg-white overflow-hidden">
        ...
        <div
          ...
          style={{ background: "#1E3A8A", top: "10%", left: -100 }}
        />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <SectionTitle
            badge="Program Studi"
            ...
            {FASILITAS.map((item, i) => (
              <div key={item.title} className="group">
                <div className="relative h-52 rounded-3xl overflow-hidden mb-4 shadow-sm">
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${item.color} opacity-50 mix-blend-multiply`}
                  />
            ...
            <div className="relative z-10 grid sm:grid-cols-3 gap-8 text-center">
              {[
                ...
                return (
                  <div
                    key={item.label}
                    className="sm:border-r sm:border-white/10 sm:last:border-r-0 sm:px-8"
                  >
                    <Icon
                      className="w-8 h-8 text-[#FBBF24] mx-auto mb-4"
                      strokeWidth={1.5}
                    />
            ...
            {KERJASAMA.map((item, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <CheckCircle
                    className="w-5 h-5 text-emerald-500 flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    strokeWidth={2}
                  />
                </div>
              </div>
