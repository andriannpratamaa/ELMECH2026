            ...
            <div className="relative z-10 grid sm:grid-cols-3 gap-6 text-center sm:text-left">
              {[
                ...
                return (
                  <div
                    key={item.label}
                    className="sm:border-r sm:border-white/10 sm:last:border-r-0 sm:px-6 first:sm:pl-0 last:sm:pr-0"
                  >
                    <Icon
                      className="w-7 h-7 text-[#FBBF24] mb-3 mx-auto sm:mx-0"
                      strokeWidth={1.5}
                    />
              ...
              >
                <div className="relative h-40 overflow-hidden mb-4">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-2 py-0.5 rounded-md bg-white/20 backdrop-blur-sm text-white text-[10px] font-semibold">
                      {item.year}
                    </span>
                  </div>
                </div>
